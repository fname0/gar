...
Клонируйте приложение или скачайте его архивом( рекомендуется убедиться, что после скачивания папка проекта называется ```gar```, либо отредактировать строку ```cd gar``` ниже )
